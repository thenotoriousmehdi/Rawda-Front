...
export default function Services(props) {
    return(
        <div className="  p-5 w-[350px] h-[400px] border border-rawdapurple border-opacity-60 md:p-8 bg-rawdawhite  xl:w-[400px] md:w-[30%] xl:h-[500px] md:h-[400px] shadow shadow-rawdapurple rounded-[8px]">
