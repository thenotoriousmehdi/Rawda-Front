    ...
    >
      <div className="flex flex-col gap-8 mb-[100px] sm:mb-[300px] mt-[-120px] sm:mt-[-120px]">
        ...
        <Swiper
          navigation={true}
          modules={[Navigation]}
          className=" w-[500px] h-[400px]  sm:w-[600px] sm:h-[400px] md:w-[900px] md:h-[550px]  "
        ...
        >
          <SwiperSlide className="flex flex-row justify-evenly items-center">
            <Member
              img={mehdi}
              name="MEHDI MAMOUNI"
              description="Etudiant 2CP G06, Designer et développeur web Front-end "
          ...
          <SwiperSlide className="flex flex-row justify-evenly items-center">
            <Member
              ...
              description="Etudiante 2CP G06, développeur web Front-end"
              github="https://github.com/Kahinasd"
            ></Member>{" "}
          </SwiperSlide>
          <SwiperSlide className="flex flex-row justify-evenly items-center">
            <Member
              img={wassim}
              name="WASSIM BELDJOUDI"
              description="Etudiant 2CP G06, développeur web Back-end"
              facebook="https://www.facebook.com/wassim.beldjoudi.9/about"
              github="https://github.com/mythsSIMOU"
              linkedin="https://www.linkedin.com/in/beldjoudi-wassim-247aaa276/"
            ></Member>{" "}
          </SwiperSlide>
          <SwiperSlide className="flex flex-row justify-center items-center">
            <Member
              img={ines}
              name="INES MEDERBEL"
              description="Etudiante 2CP G01, développeur web Front-end"
              github="https://github.com/Mederbelines"
            ></Member>
          </SwiperSlide>
          <SwiperSlide className="flex flex-row justify-center items-center">
            <Member
              ...
              name="MOULOUD SERIR"
              description="Etudiant 2CP G06, développeur web Back-end"
              github="https://github.com/Mouloud08"
            ></Member>
          </SwiperSlide>
          <SwiperSlide className="flex flex-row justify-center items-center">
            <Member
              img={amine}
              name="TIFOUN AMINE"
              description="Etudiant 2CP G02, développeur web Back-end"
              github="https://github.com/rxgofast"
