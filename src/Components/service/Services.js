...
let obj={
  ...
  des:["Vous cherchez à promouvoir les activités exceptionnelles proposées par votre crèche pour les enfants et vous ne savez pas comment? En ajoutant votre crèche à notre répertoire vous pourrez dire adieu à toute disponibilité restante dans votre établissement","Vous recherchez une crèche qui prendra soin de votre enfant avec autant d'attention que si vous étiez à ses côtés? Et pas que vous souhaitez même l'inscrire  dans l'établissement qui vous convient sans avoir à vous déplacer? N'allez pas plus loin, rawda vous permet de le faire en ligne.","Vous êtes responsable ou parent? vous pouvez toujours contacter l'autre coté en envoyant des offres à travers notre service de méssagerie"],
}

export default function Services() {
  return (
    <section
      className=" w-full h-[1700px] md:h-[900px] pt-12 pb-10 mt-36 sm:mt-24"
      id="services"
    >
