...
<div className="keen-slider__slide   h-max w-[200px]  flex flex-col justify-center items-center  rounded-xl ">
  ...
  <div className="p-5">
          <h5 className="mb-2 text-xl font-Poppins font-semibold tracking-tight text-rawdablack ">{creche.title}</h5>
           <p className="mb-3 font-Poppinsregular  text-[#475467]"> {creche.locasitiontitle} </p>
     
      <a href={`/creches/${creche.id}`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-rawdapurple rounded-lg hover:bg-rawdapurple hover:bg-opacity-80 focus:ring-4 focus:outline-none focus:ring-blue-300">
          Details
