    ...
    <footer className="bg-rawdapurple mt-5">
        ...
        <div className="px-20 py-6 bg-rawdapurple  md:flex md:items-center md:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                <a href="https://www.facebook.com/profile.php?id=100052880411339" className="text-rawdawhite hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://www.instagram.com/elme7di/" className="text-rawdawhite hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://github.com/thenotoriousmehdi" className="text-rawdawhite hover:text-gray-900 dark:hover:text-white">
