...
const Login = (props) => {
  ...
  return (
    <div className="min-h-screen bg-purple-50">
      <div className="block h-10  bg-white">
      ...
      <div className="container mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
        ...
        <div className="px-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center my-8">
              <button
                className="px-8 py-3 font-body bg-violet-800 hover:bg-violet-900 text-white rounded-xl shadow-2xl opacity-100 shadow-purple-600 focus:outline-none"
                type="submit"
              >
                Se connecter
              </button>
