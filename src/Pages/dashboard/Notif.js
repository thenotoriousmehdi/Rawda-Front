...
function Notif({ type, photo, nomc, heuree, heure, date, num, email }) {
  return (
    <div className="flex flex-col bg-rawdawhite w-[360px]  h-[250px]  border border-rawdapurple rounded-md">

      <div className="flex bg-rawdapurple bg-opacity-50 w-[360px]  h-[60px] rounded-t-md p-4 pl-6 justify-between">
        {" "}
        {/* flex top */}
      ...
      <div className="flex flex-wrap ">
        ...
        <div className="flex  ml-[80px]  items-center flex-wrap gap-4 mt-[120px] ">
          {" "}
          {/* flex buttons */}
          <div>
            <a href="/posturad">
