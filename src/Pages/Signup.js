        ...
        <form onSubmit={handleSubmit} class="w-1/3">
          <div class="flex flex-wrap justify-between mx-auto ">
            <div className="w-full container mx-auto mt-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-3 ">
              <label class="">
                <input
                  class="w-full p-3 font-body mb-4 rounded-md bg-neutral-200 border-neutral-200 focus:outline-none"
                  type="text"
                  name="Nom"
            ...
            <label class="w-full">
              <input
                class="w-full p-3 mb-4 font-body rounded-md bg-neutral-200 border-neutral-200 focus:outline-none"
                type="email"
            ...
            <label class="w-full">
              <input
                class="w-full p-3 font-body rounded-md bg-neutral-200 border-neutral-200 focus:outline-none"
                type="password"
