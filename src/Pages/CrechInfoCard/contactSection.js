...
return(
  ...
  <div className="mx-4 my-8 sm:mx-16 sm:my-16 p-5  rounded-md  bg-rawdapurple  bg-opacity-5">
       ...
       <div className="flex flex-col mb-10  items-center justify-center">
        <h3 className=" font-body font-bold sm:text-4xl  text-3xl text-rawdapurple  z-10 ">   Contacts </h3>
      ...
      <div  className=" flex flex-wrap      justify-center    " > 
       ...
       <div className="inline-flex items-center  w-64 sm:mx-20 m-1 sm:m-6 mb-9 sm:border-r-2 ">
            <svg className="w-6 h-6  mr-1 sm:mr-3 text-rawdapurple " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
            </svg>
            <span className=" font-sans font-light  text-lg sm:text-xl leading-7 pl-3" >{creche.num} </span>
        </div>
       ...
       <div className="inline-flex items-center  w-64 sm:ml-10 m-1 sm:m-6  sm:mb-9  mb-3   ">
            ...
            <span className=" font-sans font-light  text-lg sm:text-xl leading-7 pl-3"> {creche.mail}</span>
        </div>
      </div>
     ...
     <div  className=" flex flex-wrap   justify-center    " > 
       <div className="inline-flex items-center w-64 sm:border-r-2 sm:mx-20 m-1 sm:m-6 mt-9">
           ...
           <span  className=" font-sans font-light text-lg sm:text-xl leading-7 pl-3">{creche.respo}</span>
        </div>
        <div className="inline-flex items-center  w-64 sm:ml-10 m-1 sm:m-6 mt-9 ">
           ...
           <span className=" font-sans font-light  text-lg sm:text-xl leading-7 pl-3">  {creche.locasitiontitle} </span>
        </div>
    </div> 
